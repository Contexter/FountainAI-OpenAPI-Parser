...
def fix_invalid_openapi_yaml(path):
    ...
    invalid_openapi = {
        ...
        },  # placeholder to trigger validation error
    }
...
def main():
    ...
    invalid_openapi_yaml_path = os.path.join(
        test_data_dir, "invalid_openapi.yaml"
    )
    ...
    external_schema_yaml_path = os.path.join(
        test_data_dir, "external_schema.yaml"
    )
